from cacoepy.core.ARPAbet_similarity_matrix import arpabet_substitution_matrix
...
if __name__ == "__main__":
    ...
    basic_config = NeedlemanWunschConfig(gap_penalty=0, substitution=basic_score_method)
